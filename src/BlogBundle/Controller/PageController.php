...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pages = $em->getRepository('BlogBundle:Page')->findAll();
    ...
    {
        $page = new Page();
        $form = $this->createForm('BlogBundle\Form\PageType', $page);
    ...
    {
        $deleteForm = $this->createDeleteForm($page);
        $editForm = $this->createForm('BlogBundle\Form\PageType', $page);
